...
public class OrderController {
    ...
    public OrderResult findByOrdersId(String id){
        OrderResult orderResult = orderService.findByOrdersId(id);
        return orderResult;
    }
    @GetMapping("/findOrdersNotSend")
    public List<Order> findOrdersNotSend(){
        List<Order> orderList = orderService.findOrdersNotSend();
        return orderList;
    }
    @PostMapping("/findOrderByIds")
    public List<Order> findOrderByIds(String[] ids){
        List<Order> orderByIds = orderService.findOrderByIds(ids);
        return orderByIds;
    }
